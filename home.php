	...
	<section class="c" style=" background-color: aliceblue; ">
		<div class="container">
			<div class="col-lg-12 ">
				...
				<div class="col-md-4 position-relative">
					<div class="p-3 text-center">
						<a href="Infaq.php"><img src="assets/img/icons/donation.png" alt="infaq" width="100"></a>
				...
				<div class="col-md-4 position-relative">
					<div class="p-3 text-center">
						<a href="sodaqoh.php"><img src="assets/img/icons/assistance.png" alt="sodaqoh" width="100"></a>
